...
const SalaryAdd = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`http://localhost:3001/api/Emp/addSalary`, employee, {
          headers: {
      ...
      <form onSubmit={handleSubmit}>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          ...
          <div>
                ...
                <select name='department' onChange={handleDepartment} value={employee.department} className='mt-1 p-2 block w-full border border-gray-300 rounded-md' required>
