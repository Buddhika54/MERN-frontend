...
import './SupplierDashboard.css'; // Use the supplier dashboard styles
...
const Dashboard = () => {
  ...
  const statusDistributionData = {
    ...
    datasets: [
      {
        data: dashboardData.stockStatusDistribution.map(item => item.count),
        backgroundColor: [
          'rgba(76, 175, 80, 0.8)',
          'rgba(255, 152, 0, 0.8)',
          'rgba(244, 67, 54, 0.8)',
  ...
  return (
    <div className="supplier-dashboard">
      <div className="dashboard-content-container">
        ...
        {alerts.length > 0 && (
          <div className="alerts-section" style={{ marginBottom: '2rem' }}>
        ...
        {dashboardData.criticalItems.length > 0 && (
          <div className="critical-items-section" style={{ marginBottom: '2rem' }}>
            <h3 className="section-title">
              <MdError /> Critical Stock Items
            </h3>
            <div className="critical-items-grid">
              {dashboardData.criticalItems.map(item => (
                <div key={item.itemId} className="critical-item-card">
        ...
        {dashboardData.topItemsByValue.length > 0 && (
          <div className="top-items-section" style={{ marginBottom: '2rem' }}>
            ...
            <div className="top-items-grid">
              {dashboardData.topItemsByValue.slice(0, 6).map(item => (
                <div key={item.itemId} className="top-item-card">
